-- Upgrade the process_scheduled_tasks function to handle advanced recurrence patterns
-- This replaces the simple logic with robust CASE statement for all recurrence types
